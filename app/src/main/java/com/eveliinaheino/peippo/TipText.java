...
public class TipText {
    ...
    public static String getTipText(int i){
        if (i == 0) {
            ...
            return "Tuuletettussa ja viileässa (18-21 astetta) huoneessa on helpompi nukahtaa. " +
            ...
            return "Vuoteeseen tulisi mennä vain väsyneenä. Vuoteen ja unen välille voi rakentaa vahvan " +
            ...
            return "Rentoutus on tutkitusti tehokas keino unettomuuden hoitoon. Eniten tutkimustietoa on " +
            ...
            return "Tietoisesta läsnäolosta puhuttaessa tarkoitetaan omien tunteiden, ajatuksien ja kokemuksien " +
            ...
            return "Joskus nukahtamisen apuna voi käyttää mielen tiedonkäsittelyyn vaikuttavia tekniikoita, " +
            ...
            return "Jatkuvasta yli yhdeksän tunnin unentarpeesta tai poikkeavasta päiväaikaisesta väsymyksestä ja " +
